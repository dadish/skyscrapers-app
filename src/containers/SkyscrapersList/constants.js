 ...
 */
export const AJAX_FETCH_START = 'skyscrapers/SkyscrapersList/AJAX_FETCH_START';

/**
 * The AJAX search request successfully ends
 */
export const AJAX_FETCH_END = 'skyscrapers/SkyscrapersList/AJAX_FETCH_END';

/**
 * The AJAX search request fails
 */
export const AJAX_FETCH_FAIL = 'skyscrapers/SkyscrapersList/AJAX_FETCH_FAIL';

/**
 * CitiesList constants
 */

/**
 * When the user updates the search text
 */
export const CHANGE_SEARCH_TXT = 'skyscrapers/CitiesList/CHANGE_SEARCH_TXT';
 ...
 */
export const INITIAL_LOAD = 'skyscrapers/CitiesList/INITIAL_LOAD';